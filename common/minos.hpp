...
namespace minos
{
	...
	[[nodiscard]] void* reserve(u64 bytes) noexcept;

	[[nodiscard]] bool commit(void* ptr, u64 bytes) noexcept;
	...
	[[nodiscard]] bool file_create(Range<char8> filepath, Access access, CreateMode createmode, AccessPattern pattern, SyncMode syncmode, bool inheritable, FileHandle* out) noexcept;
	...
	[[nodiscard]] bool path_to_absolute(Range<char8> path, MutRange<char8> out_buf, u32* out_chars) noexcept;
